...
def compChooseWord(hand, wordList, n):
    ...
    for word in wordList:
        ...
        if isValidWord(word, hand, wordList):
            ...
            # test if the word is in the wordList - you can make a similar function that omits that test)
...
def playGame(wordList):
    ...
    while True:
        ...
        if choice == 'n':
            ...
            lastHandSize = HAND_SIZE
            while True:
                choice2 = input('Enter u to have yourself play, c to have the computer play: ')
                if choice2 == 'u':
                    playHand(lastHand, wordList, lastHandSize)
                    break
                elif choice2 == 'c':
                    compPlayHand(lastHand, wordList, lastHandSize)
                    break
                else:
                    print('Invalid input.')
        elif choice == 'r':
...
compChooseWord({'q': 1}, wordList, HAND_SIZE)
